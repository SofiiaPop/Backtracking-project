...
- Вирішення проблеми виконується за допомогою алгоритму backtracking. У найгіршому випадку, коли алгоритм повинен розглянути всі можливі комбінації кольорів для кожної вершини, складність становить 
𝑂(𝑚^𝑁), де N - кількість вершин у графі, а m - кількість кольорів.
